    ...
    const TrainingsReport = () => {
      ...
      const columns = useMemo<MRT_ColumnDef<Training>[]>(() => [
        ...
        { 
          // accessorKey: 'Psychology CEU Credit', 
          header: 'Psychology CEU Credit' 
        },
        { 
          // accessorKey: 'Social Work CEU Credit', 
          header: 'Social Work CEU Credit' 
        },
                { 
          // accessorKey: 'Social Work CEU Credit', 
          header: 'CTDS Hours' 
...
const filteredTrainings = useMemo(() => {
  ...
  // Always filter by CEU === 'Yes'
  data = data.filter((t) => t.CEU === 'Yes');

  // Apply MichiCANS filter if toggled
  if (showMichiCANS) {
    data = data.filter((t) => t.CEUTypes.includes('MichiCANS'));
  }

  return data;
}, [fetchedTrainings, showMichiCANS]);
    ...
    export default TableTrainingsReport;
