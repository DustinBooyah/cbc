...
const UsersCompletedCans = () => {
  ...
  const columns = useMemo<MRT_ColumnDef<User>[]>(() => [
    ...
    {
      header: 'MichiCANS Certification Date',
    ...
    },
    {
      ...
      header: 'MichiCANS Recertification Date',
      Cell: ({ cell }) => new Date(cell.getValue<string>()).toLocaleDateString('en-US', {
        month: 'long',
        day: 'numeric',
        year: 'numeric',
...
export default TableUsersCompletedCans;
